function ApplicationFormDto (id, jobID, jobDescrioption, employer, location, startDate, endDate, workPermit){
    this.id = id
    this.jobID = jobID
...
methods:{
    createApplicationForm: function (formid, formjobId, formjobDescription, formemployer, formlocation, formstartDate, formendDate, formworkPermit){
