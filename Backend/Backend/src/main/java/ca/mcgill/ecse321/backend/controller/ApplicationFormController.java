...
public class ApplicationFormController {
	...
	public ApplicationFormDto postApplication(@RequestParam("job_id") String jobID,
			@RequestParam("job_description") String jobDescription, @RequestParam("employer") String employer,
		...
		ApplicationFormDto applicationFormDto = new ApplicationFormDto(jobID, jobDescription, employer, location,
	...
	public ApplicationFormDto putApplication(@RequestParam(value = "job_id", required = false) String jobID,
